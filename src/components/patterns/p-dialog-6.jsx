    ...
    <>
      ...
      <div className="flex items-center justify-center">
        <Dialog>
          ...
          <DialogContent
            className="flex max-h-[calc(100vh-3rem)] w-full max-w-[calc(100vw-3rem)] flex-col overflow-hidden p-0">
            ...
            <div className="transparent-scrollbar me-0.5 flex-1 overflow-auto px-6">
              <div className="space-y-4 text-sm">
                {Array.from({ length: 20 }).map((_, index) => (
                  <p key={index} className="text-muted-foreground leading-normal">
